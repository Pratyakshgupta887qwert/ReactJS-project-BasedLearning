...
function Body(){
    return(
        ...
        <div className='flex ml-30'>
            ...
            <button className='text-white bg-black pl-5 pr-8 pt-5 pb-5 rounded-sm font-bold '>VIA SUPPORT CHAT</button>
            <button className='text-white bg-black pl-5 pr-8 pt-5 pb-5 ml-10 w-50 rounded-sm font-bold'>VIA CALL</button>
            <br></br>
            <Viaemailform/>
